/*
  ...
  - You are about to alter the column `lname` on the `User` table. The data in that column could be lost. The data in that column will be cast from `Text` to `VarChar(50)`.
...
ALTER COLUMN "lname" SET DATA TYPE VARCHAR(50),
